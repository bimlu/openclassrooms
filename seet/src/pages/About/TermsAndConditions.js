...
const TermsAndConditions = () => {
  ...
  return (
    <Container component="main" maxWidth="md" className={classes.root}>
      <Head title="Terms and conditions" desc="Terms and conditions" />
      ...
      <Box mt={2}>
        ...
        <Typography paragraph variant="caption">
          ...
          us know by emailing at <b>bimlee.official@gmail.com</b> so we can try to find a solution. These Terms apply to
        ...
        <Typography paragraph variant="caption">
          ...
          following the unsubscribe link or by emailing at bimlee.official@gmail.com.
        </Typography>
        ...
        <Typography paragraph variant="caption">
          ...
          or any third party posts on or through Service. However, by posting Content using Service you grant us the
          right and license to use, modify, publicly perform, publicly display, reproduce, and distribute such Content
          on and through Service. You agree that this license includes the right for us to make your Content available
          to other users of Service, who may also use your Content subject to these Terms.
        </Typography>
        <Typography paragraph variant="caption">
          bimlee has the right but not the obligation to monitor and edit all Content provided by users.
        </Typography>
        <Typography paragraph variant="caption">
          In addition, Content found on or through this Service are the property of bimlee or used with permission. You
        ...
        <Typography paragraph variant="caption">
          0.4. To impersonate or attempt to impersonate Company, a Company employee, another user, or any other person
          or entity.
        </Typography>
        <Typography paragraph variant="caption">
        ...
        <Typography paragraph variant="caption">
          ...
          will remain the exclusive property of bimlee and its licensors. Service is protected by copyright, trademark,
          and other laws of and foreign countries. Our trademarks may not be used in connection with any product or
          service without the prior written consent of bimlee.
        </Typography>
        <Typography paragraph variant="caption">
        ...
        <Typography paragraph variant="caption">
          ...
          bimlee.official@gmail.com, with the subject line: “Copyright Infringement” and include in your claim a
        ...
        <Typography paragraph variant="caption">
          You can contact our Copyright Agent via email at bimlee.official@gmail.com.
        </Typography>
        <Typography paragraph variant="caption">
          12. <b>Error Reporting and Feedback</b>
        </Typography>
        <Typography paragraph variant="caption">
          You may provide us either directly at bimlee.official@gmail.com or via third party sites and tools with
          ...
          (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential
        ...
        <Typography paragraph variant="caption">
          Our Service may contain links to third party web sites or services that are not owned or controlled by bimlee.
        </Typography>
        <Typography paragraph variant="caption">
          bimlee has no control over, and assumes no responsibility for the content, privacy policies, or practices of
        ...
        <Typography paragraph variant="caption">
          These Terms shall be governed and construed in accordance with the laws of India, which governing law applies
